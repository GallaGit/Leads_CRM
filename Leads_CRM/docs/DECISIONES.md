...
Esta carpeta (`Leads_CRM/`) es la ubicación de la aplicación Next.js. Este documento es la fuente de verdad de producto hasta que el código exista.
...
| 17 | Ubicación app | [`Leads_CRM/`](../) en este repo. |
